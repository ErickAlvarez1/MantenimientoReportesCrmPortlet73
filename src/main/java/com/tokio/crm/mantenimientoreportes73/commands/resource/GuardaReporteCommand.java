...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/crm/resource/mantenimientoReportes/guardaReporte"
        },
        service = MVCResourceCommand.class
)
public class GuardaReporteCommand extends BaseMVCResourceCommand {
    private static final Log _log = LogFactoryUtil.getLog(GuardaReporteCommand.class);
    ...
    protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
        ...
        try{
            ...
            Configuracion_Reporte configuracion_reporte = _Configuracion_ReporteLocalService.createConfiguracion_Reporte(0);
            ...
            _Configuracion_ReporteLocalService.addConfiguracion_Reporte(configuracion_reporte);
            respuesta.setCode(0);
